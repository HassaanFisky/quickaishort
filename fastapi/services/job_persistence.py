...
async def persist_failed_job(job_id: str, user_id: str, error: str, payload: Dict[str, Any]):
    ...
    try:
        ...
        logger.error("job_dead_lettered", job_id=job_id, user_id=user_id, error=str(error))
