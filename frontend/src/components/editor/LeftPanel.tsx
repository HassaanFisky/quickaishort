...
function DraggableClip({
  ...
  return (
    ...
    >
      ...
      {clip.viralReasoning && (
        <div className="relative overflow-hidden p-4 rounded-xl glass-surface border-border group/insight mt-4">
          ...
          {activeTab === "clips" && (
            ...
            >
              {hasSuggestions ? (
                ...
                <div className="h-[400px] flex flex-col items-center justify-center text-center p-10 rounded-3xl glass-surface border-border">
                ...
                <div className="h-[400px] flex flex-col items-center justify-center text-center p-10 rounded-3xl glass-surface border-border group">
                  ...
                  {TEXT_COLORS.map((c) => (
                    <button
                      ...
                      className={cn(
                        ...
                        textColor === c.value ? "border-primary scale-110 shadow-[0_0_10px_hsl(var(--primary)/0.4)]" : "border-border hover:border-border"
                      )}
                    >
              ...
              <div className="grid grid-cols-1 gap-2.5">
                {[
                  ...
                  <button
                    ...
                    className="w-full p-4 rounded-xl border border-border hover:border-primary/40 hover:bg-primary/5 transition-all duration-200 text-left group flex items-center justify-between"
                  >
              ...
              <div className="grid grid-cols-2 gap-2.5">
                {ELEMENT_ICONS.map(({ Icon, label, color }, i) => (
                  <button
                    ...
                    className="flex items-center gap-3 p-3.5 rounded-xl border border-border hover:border-primary/30 hover:bg-primary/5 transition-all duration-200 group"
                  >
