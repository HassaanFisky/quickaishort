  ...
  return (
    ...
    >
      <DialogContent
        ...
        className="w-[min(480px,94vw)] max-w-lg rounded-2xl border-border bg-surface p-6 shadow-2xl sm:max-w-lg"
        onEscapeKeyDown={(e) => {
      ...
      >
        ...
        {exporting && progress && (
          <div className="mb-4" role="status" aria-live="polite">
            ...
            <div
              className="h-1.5 bg-card rounded-full overflow-hidden"
              role="progressbar"
              aria-valuemin={0}
              aria-valuemax={100}
