          ...
          <CardHeader className="text-center space-y-5 pt-10 pb-2">
            ...
            <div className="space-y-1.5">
              ...
              <CardDescription className="text-[13px] text-muted-foreground">
                Join creators building viral content.
              </CardDescription>
            </div>
          </CardHeader>
          ...
          <CardContent className="pb-8 px-7 pt-5">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="relative group">
                <UserIcon className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground group-focus-within:text-primary transition-colors duration-[160ms]" aria-hidden />
                <Input
                  id="name"
                  type="text"
